...
const SRSStudySession = ({ onNavigate }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 p-4 pt-12 items-center overflow-y-auto pb-64">
      ...
      <div className={`fixed bottom-16 md:bottom-20 left-0 right-0 p-4 bg-gray-900 flex justify-center z-40 transition-all duration-300 ${isFlipped ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
        <div className="w-full max-w-2xl grid grid-cols-4 gap-2 md:gap-4 bg-gray-800 p-3 rounded-2xl border border-gray-700 shadow-2xl">
          <button 
            onClick={() => handleRate(SRS_GRADES.AGAIN)}
            className="flex flex-col items-center bg-gray-900 hover:bg-red-950 border border-gray-600 hover:border-red-500 rounded-xl py-3 transition-all hover:scale-105 active:scale-95"
          >
          ...
          <button 
            ...
            className="flex flex-col items-center bg-gray-900 hover:bg-amber-950 border border-gray-600 hover:border-amber-500 rounded-xl py-3 transition-all hover:scale-105 active:scale-95"
          >
          ...
          <button 
            ...
            className="flex flex-col items-center bg-gray-900 hover:bg-emerald-950 border border-gray-600 hover:border-emerald-500 rounded-xl py-3 transition-all hover:scale-105 active:scale-95"
          >
          ...
          <button 
            ...
            className="flex flex-col items-center bg-gray-900 hover:bg-blue-950 border border-gray-600 hover:border-blue-500 rounded-xl py-3 transition-all hover:scale-105 active:scale-95"
          >
