...
export const talperPresentationSlides = [
  ...
  },
  {
    ...
    "script": "In this discussion, / we connect our findings / to existing research. //\n\nPrior studies show / that generative AI / can support self-regulated learning —\n\nthrough feedback, prompts, / and scaffolds for reflection. //\n\nBut researchers also warn: / passive reliance on AI / can weaken learner agency / and reduce critical thinking. //\n\nOur study adds two key points. //\n\nFirst, / TALPer embedded in the SRL 4L framework / significantly improved math learning outcomes. //\n\nThis confirms that AI works best / within a structured teaching design. //\n\nSecond, / not all students benefited equally. //\n\nThose with stronger self-regulation / used TALPer to monitor and reflect. //\n\nThose with weaker awareness / mainly looked for procedures and answers. //\n\nThe takeaway is simple: / AI can support learning —\n\nbut only when learners actively regulate / how they engage with it. ///",
    "scriptZh": "在這段討論中，/ 我們將研究結果 / 與現有文獻做連結。//\n\n過去研究指出，/ 生成式 AI / 可以支持自主學習——\n\n透過回饋、提示，/ 以及反思的學習鷹架。//\n\n但研究者也提醒：/ 被動依賴 AI，/ 可能削弱學習主體性，/ 並降低批判思考能力。//\n\n我們的研究補充了兩個重點。//\n\n第一，/ 將 TALPer 整合進 SRL 4L 架構後，/ 學生的數學學習成效顯著提升。//\n\n這說明 AI 在結構化教學設計中，/ 效果最為明顯。//\n\n第二，/ 並非所有學生都同樣受益。//\n\n自主學習意識較強的學生，/ 會運用 TALPer 進行監控與反思。//\n\n意識較弱的學生，/ 則傾向尋找步驟與答案。//\n\n核心訊息很簡單：/ AI 能支持學習——\n\n但前提是學習者主動調節 / 自己與 AI 的互動方式。///",
    "narrationScript": "In this discussion,. we connect our findings. to existing research..\n\nPrior studies show. that generative AI. can support self-regulated learning —\n\nthrough feedback, prompts,. and scaffolds for reflection..\n\nBut researchers also warn:. passive reliance on AI. can weaken learner agency. and reduce critical thinking..\n\nOur study adds two key points..\n\nFirst,. TALPer embedded in the SRL 4L framework. significantly improved math learning outcomes..\n\nThis confirms that AI works best. within a structured teaching design..\n\nSecond,. not all students benefited equally..\n\nThose with stronger self-regulation. used TALPer to monitor and reflect..\n\nThose with weaker awareness. mainly looked for procedures and answers..\n\nThe takeaway is simple:. AI can support learning —\n\nbut only when learners actively regulate. how they engage with it.."
  },
  {
    "number": 15,
    "pdfPage": 15,
    ...
    "script": "This slide focuses / on what our study reveals / about the learning process. //\n\nPrior ENA research shows / that meaningful learning / lives in the connections / among cognitive processes — / not in isolated behaviors. //\n\nBuilding on this, / we used ENA / to examine how students engaged with TALPer / during AI-supported learning. //\n\nThe results showed / that high- and low-achieving students / followed very different pathways. //\n\nHigh-achieving students / focused on goal setting, / conceptual inquiry, / monitoring, / and reflection. //\n\nLow-achieving students / focused more on procedural asking / and answer seeking, / with limited reflection. //\n\nENA also revealed / distinct cognitive network structures / between the two groups. //\n\nHigh-achievers showed / integrated, multidirectional, / and densely connected networks. //\n\nLow-achievers showed / fragmented, procedural, / and less reflective networks. //\n\nIn short, / ENA helped us see / not just whether AI-supported learning differed — / but how those differences / are structurally organized. ///",
    "scriptZh": "這張投影片聚焦於 / 本研究在學習歷程上 / 所揭示的發現。//\n\n過去 ENA 研究指出，/ 有意義的學習 / 存在於認知歷程之間的連結，/ 而非單一孤立的行為。//\n\n基於此觀點，/ 我們使用 ENA / 來檢視學生在 AI 支持的學習中，/ 如何與 TALPer 互動。//\n\n結果顯示，/ 高成就與低成就學生 / 呈現出截然不同的學習路徑。//\n\n高成就學生 / 著重於目標設定、/ 概念探究、/ 監控與反思。//\n\n低成就學生 / 則更多聚焦於程序性提問 / 與尋求答案，/ 且反思相當有限。//\n\nENA 也揭示了 / 兩組學生之間 / 不同的認知網絡結構。//\n\n高成就學生呈現出 / 整合、多方向，/ 且連結密集的網絡。//\n\n低成就學生則呈現 / 較片段、程序導向，/ 且反思性較低的網絡。//\n\n簡而言之，/ ENA 幫助我們看見的，/ 不只是 AI 支持的學習是否有所不同，/ 更是這些差異 / 如何在結構上被組織起來的。///",
    "narrationScript": "This slide focuses. on what our study reveals. about the learning process..\n\nPrior ENA research shows. that meaningful learning. lives in the connections. among cognitive processes —. not in isolated behaviors..\n\nBuilding on this,. we used ENA. to examine how students engaged with TALPer. during AI-supported learning..\n\nThe results showed. that high- and low-achieving students. followed very different pathways..\n\nHigh-achieving students. focused on goal setting,. conceptual inquiry,. monitoring,. and reflection..\n\nLow-achieving students. focused more on procedural asking. and answer seeking,. with limited reflection..\n\nENA also revealed. distinct cognitive network structures. between the two groups..\n\nHigh-achievers showed. integrated, multidirectional,. and densely connected networks..\n\nLow-achievers showed. fragmented, procedural,. and less reflective networks..\n\nIn short,. ENA helped us see. not just whether AI-supported learning differed —. but how those differences. are structurally organized.."
  },
  {
    "number": 16,
    "pdfPage": 16,
