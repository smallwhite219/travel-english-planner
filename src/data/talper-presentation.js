...
export const talperPresentationSlides = [
  ...
  },
  {
    ...
    "title": "TALPer",
    "subtitle": "Rehearsal segment 0:50",
    "script": "On top of TALP, / we built TALPer. //\n\nTALPer is / our AI learning companion. //\n\nIt is powered by / ChatGPT and Gemini. //\n\nIt has an AI tutor / for students. //\n\nAnd an AI assistant / for teachers. //\n\nTALPer went nationwide / in September Twenty twenty-four. //\n\nIt has reached / about seven hundred thousand users. ///\n\nThis video shows how students use the AI learning companion, TALPer, to learn triangle congruence and similarity.\n\nStudents manipulate the triangles, compare their shapes and sizes, and receive instant feedback from TALPer.\n\nThe key point is that TALPer does not simply give answers. It guides students to notice mistakes and build clearer mathematical understanding.\n\nThis video shows how students use TALPer to develop a short writing response.\n\nTALPer gives prompts, asks students to describe the situation, and helps them add more details.\n\nThe key point is that TALPer supports students’ thinking process, rather than simply giving them a complete answer.",
    "scriptZh": "在 TALP 之上，/ 我們建置了 TALPer。//\n\nTALPer 是我們的 AI 學習夥伴。//\n\n它以 ChatGPT 與 Gemini 為基礎。//\n\n它有給學生使用的 AI 家教。//\n\n也有給教師使用的 AI 助理。//\n\nTALPer 於 2024 年 9 月全國上線。//\n\n目前已觸及約 70 萬名使用者。///\n\n這段影片展示學生如何使用 AI 學伴 TALPer，學習三角形的全等與相似。\n\n學生透過操作三角形，比較它們的形狀與大小，並即時獲得 TALPer 的回饋。\n\n這段影片的重點是，TALPer 不只是給答案，而是引導學生發現錯誤，並建立更清楚的數學理解。\n\n這段影片展示學生如何使用 TALPer 發展一段簡短的寫作回應。\n\nTALPer 會提供提示，引導學生描述情境，並協助學生補充更多細節。\n\n這段影片的重點是，TALPer 支持學生的思考歷程，而不是直接給出完整答案。",
